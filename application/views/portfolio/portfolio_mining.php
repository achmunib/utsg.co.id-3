  ...
  <section id="portfolio-details" class="portfolio-details light">
    <div class="container py-2">    
      ...
      <article class="postcard light blue">
        ...
        <a href="<?=base_url();?>asset/img/portfolio/sig-rembang-2.jpg" class="glightbox portfolio-lightbox"></a>
        <a href="<?=base_url();?>asset/img/portfolio/sig-rembang-3.jpg" class="glightbox portfolio-lightbox"></a>
