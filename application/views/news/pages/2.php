          ...
          <div class="card-body">
            ...
            <div class="row">
              <ul class="pagination justify-content-center">
                <li class="page-item">
                  <a class="page-link" href="<?=base_url();?>user/news/1" tabindex="-1" aria-disabled="true">Previous</a>
                </li>
                <li class="page-item"><a class="page-link" href="<?=base_url();?>user/news/1">1</a></li>
                <li class="page-item active"><a class="page-link" href="#">2</a></li>
                <li class="page-item"><a class="page-link" href="<?=base_url();?>user/news/3">3</a></li>
                <li class="page-item">
                  <a class="page-link" href="<?=base_url();?>user/news/3">Next</a>
                </li>
              </ul>
            </div>
          </div>
